var aliasConfig = {
	...
	;
		...
		productName : 'Tirth Infotech Ebook',
		homePage : 'http://www.tirthinfotech.com/',
		isFlipPdf : "true",
	...
	bookConfig.iconFontColor="#C6C6C6";
	...
	bookConfig.bgBeginColor = "#8080FF";
	bookConfig.bgEndColor = "#80FFFF";
	...
	bookConfig.thicknessWidthType = "Thicker";
	...
	bookConfig.MidBgColor = "#186844";
	bookConfig.useTheAliCloudChart = "no";
	bookConfig.totalPageCount = 528;
	bookConfig.largePageWidth = 1800;
	bookConfig.largePageHeight = 2282;;
	bookConfig.securityType = "1";
	bookConfig.CreatedTime = "210617182213";
	bookConfig.bookTitle = "1100001";
	bookConfig.bookmarkCR = "535a39df2956a2cc4073daae8ef5daa1bf66771a";
	bookConfig.productName = "Flip PDF";
	bookConfig.homePage = "http://www.tirthinfotech.com";
	bookConfig.searchPositionJS = "mobile/javascript/text_position[1].js";
	bookConfig.searchTextJS = "mobile/javascript/search_config.js";
	bookConfig.normalPath = "files/mobile/";
	bookConfig.largePath = "files/mobile/";
	bookConfig.thumbPath = "files/mobile/";
